 ...
 *  Deskripsi   : Program untuk mendefinisikan kelas Segitiga yang merupakan turunan dari kelas BangunDatarGeneric
 *  Pembuat     : Rajwaa Muflihul Aufaa
 *  NIM         : 24060123140189
 *  Tanggal     : 8 Mei 2025
 */

public class Segitiga<T extends Number> extends BangunDatarGeneric<T> {
    private T alas;
    private T tinggi;
    private T sisi1;
    private T sisi2;
